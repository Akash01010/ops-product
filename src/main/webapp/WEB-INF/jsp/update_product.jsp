	...
	<div class="container">
			<div class="row main">
				...
				<div class="main-login main-center">
					<form:form class="form-horizontal" modelAttribute="product" method="post" action="posteditp">
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<form:input path="product_id"  cssClass="form-control" id="product_id" readonly="true" />									
								</div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="manufacture_date" class="cols-sm-2 control-label">Enter Product manufacture_date(dd/MM/yyyy)</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
						...
						<div class="form-group">
							<label for="buying_price" class="cols-sm-2 control-label">Enter Buying Price</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
